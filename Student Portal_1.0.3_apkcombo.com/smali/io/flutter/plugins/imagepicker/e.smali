...
# interfaces
.implements Lc/a/c/a/k;
.implements Lc/a/c/a/n;
...
.field private k:Lc/a/c/a/i$d;

.field private l:Lc/a/c/a/h;


# direct methods
.method constructor <init>(Landroid/app/Activity;Ljava/io/File;Lio/flutter/plugins/imagepicker/g;Lc/a/c/a/i$d;Lc/a/c/a/h;Lio/flutter/plugins/imagepicker/d;Lio/flutter/plugins/imagepicker/e$g;Lio/flutter/plugins/imagepicker/e$e;Lio/flutter/plugins/imagepicker/c;)V
    .locals 0
    ...
    iput-object p4, p0, Lio/flutter/plugins/imagepicker/e;->k:Lc/a/c/a/i$d;

    iput-object p5, p0, Lio/flutter/plugins/imagepicker/e;->l:Lc/a/c/a/h;
...
.method public constructor <init>(Landroid/app/Activity;Ljava/io/File;Lio/flutter/plugins/imagepicker/g;Lio/flutter/plugins/imagepicker/d;)V
    ...
    invoke-direct/range {v0 .. v9}, Lio/flutter/plugins/imagepicker/e;-><init>(Landroid/app/Activity;Ljava/io/File;Lio/flutter/plugins/imagepicker/g;Lc/a/c/a/i$d;Lc/a/c/a/h;Lio/flutter/plugins/imagepicker/d;Lio/flutter/plugins/imagepicker/e$g;Lio/flutter/plugins/imagepicker/e$e;Lio/flutter/plugins/imagepicker/c;)V
...
.method private C()V
    ...
    sget-object v2, Lio/flutter/plugins/imagepicker/a;->b:Lio/flutter/plugins/imagepicker/a;

    if-ne v1, v2, :cond_0

    invoke-direct {p0, v0}, Lio/flutter/plugins/imagepicker/e;->L(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v0, v2}, Lio/flutter/plugins/imagepicker/e;->q(Landroid/content/Intent;Landroid/net/Uri;)V
    ...
    invoke-direct {p0, v0, v1}, Lio/flutter/plugins/imagepicker/e;->m(Ljava/lang/String;Ljava/lang/String;)V
...
.method private D()V
    ...
    iget-object v1, p0, Lio/flutter/plugins/imagepicker/e;->l:Lc/a/c/a/h;

    if-eqz v1, :cond_0

    const-string v2, "maxDuration"

    invoke-virtual {v1, v2}, Lc/a/c/a/h;->a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    :cond_1
    invoke-direct {p0}, Lio/flutter/plugins/imagepicker/e;->k()Ljava/io/File;
...
.method private I(Lc/a/c/a/h;Lc/a/c/a/i$d;)Z
    .locals 1

    iget-object v0, p0, Lio/flutter/plugins/imagepicker/e;->k:Lc/a/c/a/i$d;
    ...
    :cond_0
    iput-object p1, p0, Lio/flutter/plugins/imagepicker/e;->l:Lc/a/c/a/h;

    iput-object p2, p0, Lio/flutter/plugins/imagepicker/e;->k:Lc/a/c/a/i$d;
...
.method static synthetic b(Lio/flutter/plugins/imagepicker/e;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/plugins/imagepicker/e;->w(Ljava/lang/String;Z)V

    return-void
.end method

.method static synthetic d(Lio/flutter/plugins/imagepicker/e;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugins/imagepicker/e;->y(Ljava/lang/String;)V
...
.method private h()V
    ...
    iput-object v0, p0, Lio/flutter/plugins/imagepicker/e;->l:Lc/a/c/a/h;

    iput-object v0, p0, Lio/flutter/plugins/imagepicker/e;->k:Lc/a/c/a/i$d;

    return-void
.end method

.method private i(Ljava/lang/String;)Ljava/io/File;
    .locals 2
...
.method private j()Ljava/io/File;
    ...
    invoke-direct {p0, v0}, Lio/flutter/plugins/imagepicker/e;->i(Ljava/lang/String;)Ljava/io/File;
...
.method private l(Lc/a/c/a/i$d;)V
    .locals 3
    ...
    invoke-interface {p1, v0, v1, v2}, Lc/a/c/a/i$d;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method private m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-interface {v0, p1, p2, v1}, Lc/a/c/a/i$d;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    invoke-direct {p0}, Lio/flutter/plugins/imagepicker/e;->h()V
...
.method private p(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/plugins/imagepicker/e;->l:Lc/a/c/a/h;

    const-string v1, "maxWidth"

    invoke-virtual {v0, v1}, Lc/a/c/a/h;->a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lio/flutter/plugins/imagepicker/e;->l:Lc/a/c/a/h;
...
.method private q(Landroid/content/Intent;Landroid/net/Uri;)V
    .locals 3
...
.method private r(I)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugins/imagepicker/e;->o(Ljava/lang/String;)V
...
.method private u(ILandroid/content/Intent;)V
    ...
    :cond_1
    invoke-direct {p0, p1, v1}, Lio/flutter/plugins/imagepicker/e;->x(Ljava/util/ArrayList;Z)V
...
.method private w(Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugins/imagepicker/e;->p(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0, v0}, Lio/flutter/plugins/imagepicker/e;->o(Ljava/lang/String;)V
...
.method private x(Ljava/util/ArrayList;Z)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v2}, Lio/flutter/plugins/imagepicker/e;->p(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-direct {p0, v0}, Lio/flutter/plugins/imagepicker/e;->n(Ljava/util/ArrayList;)V

    goto :goto_1

    :cond_2
    invoke-direct {p0, p1}, Lio/flutter/plugins/imagepicker/e;->n(Ljava/util/ArrayList;)V
...
.method F(Lc/a/c/a/i$d;)V
    ...
    :cond_3
    invoke-interface {p1, v0}, Lc/a/c/a/i$d;->b(Ljava/lang/Object;)V
...
.method G()V
    ...
    iget-object v0, v0, Lc/a/c/a/h;->a:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lio/flutter/plugins/imagepicker/d;->d(Lc/a/c/a/h;)V
...
.method H(Lio/flutter/plugins/imagepicker/a;)V
    .locals 0
...
.method public J(Lc/a/c/a/h;Lc/a/c/a/i$d;)V
    .locals 1

    invoke-direct {p0, p1, p2}, Lio/flutter/plugins/imagepicker/e;->I(Lc/a/c/a/h;Lc/a/c/a/i$d;)Z

    move-result p1

    if-nez p1, :cond_0

    invoke-direct {p0, p2}, Lio/flutter/plugins/imagepicker/e;->l(Lc/a/c/a/i$d;)V

    return-void

    :cond_0
    invoke-direct {p0}, Lio/flutter/plugins/imagepicker/e;->E()Z
    ...
    invoke-interface {p1, p2}, Lio/flutter/plugins/imagepicker/e$g;->a(Ljava/lang/String;)Z
    ...
    invoke-interface {p1, p2, v0}, Lio/flutter/plugins/imagepicker/e$g;->c(Ljava/lang/String;I)V
...
.method public K(Lc/a/c/a/h;Lc/a/c/a/i$d;)V
    .locals 1
    ...
    :cond_1
    invoke-direct {p0}, Lio/flutter/plugins/imagepicker/e;->D()V
...
.method public a(I[Ljava/lang/String;[I)Z
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/plugins/imagepicker/e;->m(Ljava/lang/String;Ljava/lang/String;)V
...
.method public c(IILandroid/content/Intent;)Z
    ...
    :cond_0
    invoke-direct {p0, p2}, Lio/flutter/plugins/imagepicker/e;->s(I)V

    goto :goto_0

    :cond_1
    invoke-direct {p0, p2, p3}, Lio/flutter/plugins/imagepicker/e;->v(ILandroid/content/Intent;)V
...
.method public e(Lc/a/c/a/h;Lc/a/c/a/i$d;)V
    .locals 0
...
.method public g(Lc/a/c/a/h;Lc/a/c/a/i$d;)V
    .locals 0
