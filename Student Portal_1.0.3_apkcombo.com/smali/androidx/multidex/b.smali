...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-static {p1}, Landroidx/multidex/b;->f(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, Landroidx/multidex/b;->b:J
    ...
    invoke-static {p2}, Landroidx/multidex/b;->b(Ljava/io/Closeable;)V
...
.method private a()V
    ...
    new-instance v1, Landroidx/multidex/b$a;

    invoke-direct {v1, p0}, Landroidx/multidex/b$a;-><init>(Landroidx/multidex/b;)V
...
.method private static c(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Landroidx/multidex/b;->b(Ljava/io/Closeable;)V
...
.method private static f(Ljava/io/File;)J
    ...
    invoke-static {p0}, Landroidx/multidex/c;->c(Ljava/io/File;)J
...
.method private static g(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p0}, Landroidx/multidex/b;->d(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {p1}, Landroidx/multidex/b;->e(Ljava/io/File;)J
...
.method private i(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static/range {p1 .. p1}, Landroidx/multidex/b;->d(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    new-instance v8, Landroidx/multidex/b$b;

    iget-object v9, v0, Landroidx/multidex/b;->c:Ljava/io/File;

    invoke-direct {v8, v9, v7}, Landroidx/multidex/b$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, Landroidx/multidex/b;->f(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, Landroidx/multidex/b$b;->a:J
    ...
    iget-wide v2, v8, Landroidx/multidex/b$b;->a:J
    ...
    iget-wide v4, v8, Landroidx/multidex/b$b;->a:J
...
.method private j()Ljava/util/List;
    ...
    iget-object v6, v1, Landroidx/multidex/b;->a:Ljava/io/File;
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/multidex/b;->a()V
    ...
    iget-object v0, v1, Landroidx/multidex/b;->a:Ljava/io/File;
    ...
    new-instance v11, Landroidx/multidex/b$b;

    iget-object v12, v1, Landroidx/multidex/b;->c:Ljava/io/File;

    invoke-direct {v11, v12, v0}, Landroidx/multidex/b$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v10, v11, v6}, Landroidx/multidex/b;->c(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, Landroidx/multidex/b;->f(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, Landroidx/multidex/b$b;->a:J
    :try_end_1
    ...
    iget-wide v12, v11, Landroidx/multidex/b$b;->a:J
...
.method private static k(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    ...
    check-cast p4, Landroidx/multidex/b$b;
    ...
    iget-wide v0, p4, Landroidx/multidex/b$b;->a:J
...
.method h(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-wide v2, p0, Landroidx/multidex/b;->b:J

    invoke-static {p1, v0, v2, v3, p2}, Landroidx/multidex/b;->g(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/multidex/b;->i(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_1
    invoke-direct {p0}, Landroidx/multidex/b;->j()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, Landroidx/multidex/b;->a:Ljava/io/File;

    invoke-static {v0}, Landroidx/multidex/b;->e(Ljava/io/File;)J
    ...
    invoke-static/range {v2 .. v8}, Landroidx/multidex/b;->k(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
