...
public class p implements g<Object> {
    ...
    public static final p f217a = new p();

    /* renamed from: b  reason: collision with root package name */
    private static final boolean f218b;

    /* renamed from: c  reason: collision with root package name */
    private static final Charset f219c;
    ...
    static {
        f218b = ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN;
        f219c = Charset.forName("UTF8");
    }
    ...
    protected static final void l(ByteArrayOutputStream byteArrayOutputStream, float f) {
    ...
    protected Object g(byte b2, ByteBuffer byteBuffer) {
        ...
        switch (b2) {
            ...
            case 5:
                return new BigInteger(new String(d(byteBuffer), f219c), 16);
            case 6:
                c(byteBuffer, 8);
                return Double.valueOf(byteBuffer.getDouble());
            case 7:
                return new String(d(byteBuffer), f219c);
            case 8:
                return d(byteBuffer);
            case 9:
                e = e(byteBuffer);
    ...
    public void p(ByteArrayOutputStream byteArrayOutputStream, Object obj) {
        ...
        if (obj == null || obj.equals(null)) {
            ...
            if ((obj instanceof Integer) || (obj instanceof Short) || (obj instanceof Byte)) {
                ...
                i(byteArrayOutputStream, ((BigInteger) obj).toString(16).getBytes(f219c));
            }
        } else if (obj instanceof CharSequence) {
            byteArrayOutputStream.write(7);
            i(byteArrayOutputStream, obj.toString().getBytes(f219c));
