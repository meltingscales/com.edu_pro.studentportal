...
.method private f(Lio/flutter/embedding/android/k;)V
    .locals 2
...
.method private g()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/f/a;->h()Z
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->b()Landroid/app/Activity;
    ...
    invoke-virtual {v0}, Lc/a/a;->b()Lio/flutter/embedding/engine/h/c;

    move-result-object v0

    invoke-virtual {v0}, Lio/flutter/embedding/engine/h/c;->e()Ljava/lang/String;

    move-result-object v0

    :cond_4
    new-instance v1, Lio/flutter/embedding/engine/f/a$b;
    ...
    invoke-direct {v1, v0, v2}, Lio/flutter/embedding/engine/f/a$b;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lio/flutter/embedding/engine/f/a;->f(Lio/flutter/embedding/engine/f/a$b;)V
...
.method B(I)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/f/a;->i()V
...
.method E()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/f$c;->z()Landroid/content/Context;
...
.method m(IILandroid/content/Intent;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lio/flutter/embedding/engine/i/c/b;->c(IILandroid/content/Intent;)Z
...
.method n(Landroid/content/Context;)V
    ...
    invoke-interface {p1}, Lio/flutter/embedding/android/f$c;->b()Landroid/app/Activity;

    move-result-object v0

    iget-object v1, p0, Lio/flutter/embedding/android/f;->b:Lio/flutter/embedding/engine/b;

    invoke-interface {p1, v0, v1}, Lio/flutter/embedding/android/f$c;->y(Landroid/app/Activity;Lio/flutter/embedding/engine/b;)Lio/flutter/plugin/platform/e;
...
.method p(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;IZ)Landroid/view/View;
    ...
    invoke-interface {p3}, Lio/flutter/embedding/android/f$c;->z()Landroid/content/Context;

    move-result-object p3

    iget-object v2, p0, Lio/flutter/embedding/android/f;->a:Lio/flutter/embedding/android/f$c;

    invoke-interface {v2}, Lio/flutter/embedding/android/f$c;->q()Lio/flutter/embedding/android/r;
    ...
    invoke-interface {p3, p2}, Lio/flutter/embedding/android/f$c;->A(Lio/flutter/embedding/android/i;)V

    new-instance p3, Lio/flutter/embedding/android/k;

    iget-object v0, p0, Lio/flutter/embedding/android/f;->a:Lio/flutter/embedding/android/f$c;

    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->z()Landroid/content/Context;
    ...
    invoke-interface {p3}, Lio/flutter/embedding/android/f$c;->q()Lio/flutter/embedding/android/r;
    ...
    invoke-interface {p2}, Lio/flutter/embedding/android/f$c;->x()Lio/flutter/embedding/android/q;
    ...
    invoke-direct {p0, p1}, Lio/flutter/embedding/android/f;->f(Lio/flutter/embedding/android/k;)V
...
.method s(Landroid/content/Intent;)V
    ...
    invoke-interface {v0, p1}, Lio/flutter/embedding/engine/i/c/b;->d(Landroid/content/Intent;)V
